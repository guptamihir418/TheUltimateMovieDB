  ...
  const formik = useFormik( {
    ...
    onSubmit: async values => {
      ...
      if ( response.status === 200 ) {
        ...
        alert( `You have added a new user with these details:\nEmail: ${values.email} \nPassword: ${values.password}` )
      } else {
    ...
    <Layout>
      ...
      <div className="md:flex md:items-center md:-mt-16 md:h-screen pt-6">
        ...
        >
          ...
          <h1 className="text-2xl font-bold text-center">Add new user to contribute</h1>

          {registerFormOptions.map( ( { id, type, placeholder } ) => (
            <label className="myLabel" htmlFor={id} key={id}>
